                                                                    ...
                                                                    <div className="wpforms-field-container" >
                                                                        <div className="container" style={{ display: 'flex' }}>
                                                                            <div id="wpforms-10207-field_1-container" className="wpforms-field wpforms-field-name wpforms-one-half wpforms-first">
                                                                                <input type="text" id="wpforms-10207-field_1" className="wpforms-field-large wpforms-field-required wpforms-valid" placeholder="Your Name" style={{ padding: '18px' }} />
                                                                            </div>
                                                                            <div id="wpforms-10207-field_4-container" className="wpforms-field wpforms-field-name wpforms-one-half wpforms-first">
                                                                                <input type="email" id="wpforms-10207-field_1" className="wpforms-field-large wpforms-field-required wpforms-valid" placeholder="Your Email" style={{ marginLeft: '15px', padding: '18px' }} />
                                                                            </div>
                                                                        </div>

                                                                        <div id="wpforms-10207-field_5-container" className="wpforms-field wpforms-field-name wpforms-one-half wpforms-first">
                                                                            <textarea name="" className="wpforms-field-large" id="wpforms-10207-field_5" placeholder="Message"></textarea>
                                                                        </div>
                                                                    </div>
                                                                    <div className="wpforms-submit-container">
                                                                        <button id="wpforms-submit-10207" className="wpforms-submit" style={{ backgroundColor: '#ff5400', color: '#FFF', height: '60px', paddingLeft: '26px', paddingRight: '26px', fontWeight: 'bold' }}>Send Message</button>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </div>
